...
function getItemPriceByName(items, name) {
  ...
  return undefined; //Em: add this to catch errors if name is not found (perhaps not necessary?) -- machen
...
function getItemsByCategory(items, category) {
  // TODO: use `filter` - done ; Em: similar logic to getItemPriceByName()
...
function countItems(items) {
  // TODO: use `reduce` - done ; Em: better to have initial value as Paul mentioned in class -> remember to add that!
...
function getTotalPrice(items) {
  // TODO: use `reduce` - done ; Em: similar to the previous function, except update the second line to quantity * price to be the cost
